...
getwd()
setwd("H:/Meu Drive/Especialização/03-FCD/04-Machine Learning/11-Classificacao_e_regressao_com_SVMs/1-Cap11-R/R/dados")
...
?read.csv
dados_treino1 <- read.csv("dados_treino_balanceados.csv")
dados_teste1 <- read.csv("dados_teste.csv")
dim(dados_treino1)
dim(dados_teste1)
View(dados_treino1)
View(dados_teste1)
...
?read_csv
dados_treino <- read_csv("dados_treino_balanceados.csv")
dados_teste <- read_csv("dados_teste.csv")
dim(dados_treino)
dim(dados_teste)
View(dados_treino)
View(dados_teste)
...
novos_clientes <- read.csv("novos_clientes.csv", header = TRUE)
View(novos_clientes)
dim(novos_clientes)
...
View(resultado_final)
write.csv(resultado_final, "resultado_final.csv")
